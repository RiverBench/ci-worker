...
object DatasetDocGenCommand extends Command:
  ...
  def run(args: Array[String]): Future[Unit] = Future {
    ...
    // TODO: add pretty status badges
    val docReadme = docBuilderReadme.build(mi.description + readmeIntro(mi.landingPage), datasetRes)
    Files.writeString(outputDir.resolve("README.md"), readmeHeader + "\n\n" + docReadme.toMarkdown)
  ...
  private def readmeHeader: String =
    """<!--
      |--
